...
const ChatInterface = ({ messages, setMessages, addInvoice }) => {
  ...
  const handleFileUpload = (e) => {
    ...
    reader.onloadend = () => {
      ...
      const userMessage = { id: Date.now(), sender: "user", image: imageUrl, type: "image" };
...
>
        ...
        {isTyping && <div className="text-gray-400 text-sm p-4">جاري الكتابة...</div>}
        <div ref={messagesEndRef} />
      </div>
      <div className="p-3 bg-whith">
